...
/**
 * A class containing a few helper methods that may be useful for the flood-fill
 * lab assignment.
 */
public class Utilities {
     ...
     *
     * @param pixelA an integer pixel value (in the form produced by
     *               BufferedImage.getRGB(x,y) )
     * @param pixelB an integer pixel value (in the form produced by
     *               BufferedImage.getRGB(x,y) )
    ...
    public static double computeDelta(int pixelA, int pixelB) {
        ...
        float dist2 = (hsbA[0] - hsbB[0]) * (hsbA[0] - hsbB[0]) +
